package es.codigoandroid.advanced;
...
import es.codigoandroid.geoturse.R;
...
public class ScreenshotSaverExtension extends ArchitectViewExtension implements ArchitectJavaScriptInterfaceListener {
    ...
    private final PermissionManager.PermissionManagerCallback permissionManagerCallback = new PermissionManager.PermissionManagerCallback() {
        ...
        public void permissionsDenied(@NonNull final String[] deniedPermissions) {
            Toast.makeText(activity, "Nececitas habilitar permisos de AR experience." + Arrays.toString(deniedPermissions), Toast.LENGTH_SHORT).show();
        }
        ...
        public void showPermissionRationale(final int requestCode, @NonNull String[] strings) {
            ...
            alertBuilder.setTitle("Geoturse Permissions");
            alertBuilder.setMessage("Nececitas habilitar permisos de AR experience" + Manifest.permission.WRITE_EXTERNAL_STORAGE);
    ...
    public void onJSONObjectReceived(JSONObject jsonObject) {
        try {
            ...
            activity.runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    Toast.makeText(activity, "desabilitado la conversion de json data from AR-Experience", Toast.LENGTH_LONG).show();
                }
            });
        }
    }
            ...
            try {
                ...
                activity.runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(activity, "Error inexplicable" + e, Toast.LENGTH_LONG).show();
                    }
                });
            }
        }
