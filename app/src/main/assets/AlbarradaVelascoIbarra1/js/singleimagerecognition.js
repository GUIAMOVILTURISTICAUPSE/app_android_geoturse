var World = {
                 ...
                 createOverlays: function createOverlaysFn() {
                  ...
                  //   alert("Aqui se crea el overlay basico");  console.log("Aqui se crea el overlay basico");

                     this.bannerImg = new AR.Model("assets/foca_ballena.wt3", {
                   ...
                   //  alert("myJSONBannerImg: " + myJSONBannerImg); console.log("myJSONBannerImg: " + myJSONBannerImg);
                 ...
                 onRecognition: function onRecognitionFn(recognized, response) {
                     if (recognized) {
                         ...
                         //console.log("JSon en la consola:" + myJSON); console.log("Reconocio 1");
                        // alert("Reconocio 1");
                       ...
                       //  console.log("Reconocio 2 :" + response.targetInfo.name); alert(response.targetInfo.name);

                         World.wineLabel = new AR.ImageResource("assets/rotateButton.jpg");

                      //   console.log("Reconocio 3:" + World.wineLabel);  alert(World.wineLabel);
                        ...
                        //     console.log("Ok. WineLabelAugmentation Definido y se borrarse como el Crush");   alert("Ok. WineLabelAugmentation Definido y se borrarse como el Crush");
                     ...
                     World.wineLabelAugmentation = new AR.ImageTrackable(World.tracker, response.targetInfo.name, {
                             drawables: {
                                 cam: [World.bannerImg,World.wineLabelOverlay]
                             },
