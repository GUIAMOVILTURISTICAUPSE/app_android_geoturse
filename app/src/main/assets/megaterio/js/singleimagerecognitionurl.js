var World = {
             ...
             */
                     ...
                     World.wineLabelAugmentation = new AR.ImageTrackable(World.tracker, response.targetInfo.name, {
                         ...
                         console.log("Esto no es un error, pero si fuese se deberia ver asi: " + World.error+ "segun nombre: " + World.wineName +" vv:" +response.metadata.name );
                         var myJSONWLA = JSON.stringify(World.wineLabelAugmentation);
                         console.log("Reconocio 4:" + myJSONWLA+"   reconocido 5 : el nmbre de la reconoido "+ World.wineName+" vv:" +response.metadata.name);
                         alert(myJSONWLA);
